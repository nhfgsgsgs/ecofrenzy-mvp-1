...
Future<List<Map<String, dynamic>>> fetchMissions() async {
  ...
  final response = await http
      .get(Uri.parse('https://ea9pgpvvaa.execute-api.ap-southeast-1.amazonaws.com/prod/api/user/$id/getToday'));
...
Future<String> updateMission(String id) async {
  ...
  final response = await http.put(
    Uri.parse('https://ea9pgpvvaa.execute-api.ap-southeast-1.amazonaws.com/prod/api/user/updateToday'),
