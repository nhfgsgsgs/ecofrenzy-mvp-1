...
class ChallengeView extends StackedView<ChallengeViewModel> {
  ...
  Widget builder(
    ...
    return const Scaffold(
      body: Text('Challenge View'),
    );
  }

  @override
  ChallengeViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      ChallengeViewModel();
}
...
//   void initState() {
//     super.initState();
//     futureChallenges = challengeService.getChallenges();
